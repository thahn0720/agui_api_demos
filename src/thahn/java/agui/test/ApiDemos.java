...
import thahn.java.agui.content.pm.ResolveInfo;
import thahn.java.agui.view.View;
import thahn.java.agui.widget.ListView;
import thahn.java.agui.widget.SimpleAdapter;
...
public class ApiDemos extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setListAdapter(new SimpleAdapter(this, getData(path),
        		thahn.java.agui.R.layout.simple_list_item_1, new String[] { "title" },
                new int[] { thahn.java.agui.R.id.text1 }));
